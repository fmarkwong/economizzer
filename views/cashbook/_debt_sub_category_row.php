...
$updateDebtTotalLink = Html::a($debtTotal, [$budgetUrl, 'id' => $budgetId, 'category-id' => $categoryId, 'show-debt-total-field' => 'true'], ['id' => "debt-total-category-id-$categoryId"]);
...
<tr class="shift" style="cursor: pointer" data-key="<?=$budgetId?>">
    ...
    <td style="text-align:left;padding-left: 1.5em"><strong style='color: <?= 0 ?>'><?="$updateDebtTotalLink / $percentageCompleted"?></strong></td>
</tr>
